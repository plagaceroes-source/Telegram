...
class Source(Base):
    ...
    added_at: Mapped[dt.datetime] = mapped_column(default=utcnow)
...
class SubscriberEvent(Base):
    ...
    occurred_at: Mapped[dt.datetime] = mapped_column(default=utcnow)
...
class ChannelStatsDaily(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    target_channel_id: Mapped[int] = mapped_column(ForeignKey("target_channels.id"))
    snapshot_at: Mapped[dt.datetime] = mapped_column(default=utcnow)
